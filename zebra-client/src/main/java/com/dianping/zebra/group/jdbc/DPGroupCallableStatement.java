...
public class DPGroupCallableStatement extends DPGroupPreparedStatement implements CallableStatement {
	...
	public DPGroupCallableStatement(GroupDataSourceRouter router, GroupDataSourceManager dataSourceManager,
	      GroupConfigManager configManager, DPGroupConnection connection, CallableStatement actualCallableStatement,
	      String sql) {
		super(router, dataSourceManager, configManager, connection, sql);
