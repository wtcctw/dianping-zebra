...
public class GroupStatement implements Statement {
	...
	protected void beforeExecuteWithCat(String sql) {
		...
		if (isLoged == null) {
			...
			Transaction t = cat.newTransaction("SQL", sql);
			t.addData(sql);
		}
	...
	public int[] executeBatch() throws SQLException {
		try {
			...
			beforeExecuteWithCat("Batch");

			final Connection conn = this.dpGroupConnection.getRealConnection(null, true);
	...
	protected <T> T executeWithCat(JDBCOperationCallback<T> callback, String sql, Object params) throws SQLException {
