...
import com.dianping.zebra.jdbc.data.processor.AggregateDataProcessException;
import com.dianping.zebra.jdbc.data.processor.AggregateDataProcessor;
import com.dianping.zebra.jdbc.data.processor.CountDataProcessor;
import com.dianping.zebra.jdbc.data.processor.MaxDataProcessor;
import com.dianping.zebra.jdbc.data.processor.MinDataProcessor;
import com.dianping.zebra.jdbc.data.processor.SumDataProcessor;
import com.dianping.zebra.parser.sqlParser.Column;
import com.dianping.zebra.parser.sqlParser.OrderByEle;
import com.dianping.zebra.parser.sqlParser.groupFunction.Count;
import com.dianping.zebra.parser.sqlParser.groupFunction.Max;
import com.dianping.zebra.parser.sqlParser.groupFunction.Min;
import com.dianping.zebra.parser.sqlParser.groupFunction.Sum;
...
public class DefaultDataMerger implements DataMerger {
	...
	public void merge(DataPool dataPool, RouterTarget routerTarget, List<ResultSet> actualResultSets)
		...
		} else if ((routerTarget.getTargetedSqls().size() > 1 || routerTarget.getTargetedSqls().get(0).getSqls().size() > 1)
