...
public class MonitorableStatement implements Statement {
	...
	protected SqlMonitor 					sqlMonitor;
	...
	public MonitorableStatement(Statement statement, MonitorableConnection monitorableConnection) {
		...
		this.sqlMonitor = new SqlMonitorImpl(monitorableConnection.getInnerConnection());
	}
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		checkClosed();
		sqlMonitor.beforeSqlExecute(sql);
		try {
