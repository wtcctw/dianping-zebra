 ...
 * 
 */
public abstract class ZebraMultiMonitorableDBBasedTestCase extends DataSourceBasedDBTestCase {
	...
	private List<DBDataEntry> parseDataFile() throws Exception {
		...
		Document configDoc = builder.parse(ZebraMultiMonitorableDBBasedTestCase.class.getClassLoader().getResourceAsStream(
				getDataFile()));
