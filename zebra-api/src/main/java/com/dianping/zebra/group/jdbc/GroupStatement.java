...
public class GroupStatement implements Statement {
	 ...
	 */
	@Override
	public void addBatch(String originSql) throws SQLException {
		checkClosed();

		final String sql = processSQL(originSql);
	 ...
	 */
	@Override
	public ResultSet executeQuery(String originSql) throws SQLException {
		checkClosed();
		closeCurrentResultSet();
	...
	private int executeUpdateInternal(String originSql, final int autoGeneratedKeys, final int[] columnIndexes,
	...
	protected String processSQL(final String sql) {
		return filter.sql(this.metaData.clone(), this, new FilterFunction<GroupStatement, String>() {
			@Override public String execute(GroupStatement source) {
				return sql;
			}
		});
	}
