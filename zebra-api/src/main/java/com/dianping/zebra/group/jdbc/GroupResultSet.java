...
public class GroupResultSet implements ResultSet {
	...
	public GroupResultSet(JdbcContext context, JdbcFilter filter, ResultSet resultSet) {
	...
	public boolean next() throws SQLException {
		return this.filter.resultSetNext(this.context.clone(), this,
		      new FilterFunctionWithSQLException<GroupResultSet, Boolean>() {
			      @Override
			      public Boolean execute(GroupResultSet source) throws SQLException {
