...
public class GroupDataSourceConfig extends BaseEntity<GroupDataSourceConfig> {
	private volatile String m_routerStrategy = "roundrobin";

	private volatile boolean m_transactionForceWrite = false;

	private volatile boolean m_writeFirst = false;

	private volatile String m_filters = "";

	private volatile Map<String, DataSourceConfig> m_dataSourceConfigs = new LinkedHashMap<String, DataSourceConfig>();
	...
	public boolean equals(Object obj) {
		if (obj instanceof GroupDataSourceConfig) {
			...
			result &= (m_routerStrategy == routerStrategy || m_routerStrategy != null && m_routerStrategy
				.equals(routerStrategy));
			...
			result &= (m_dataSourceConfigs == dataSourceConfigs || m_dataSourceConfigs != null && m_dataSourceConfigs
				.equals(dataSourceConfigs));
