...
public class SystemConfig extends BaseEntity<SystemConfig> {
   private int m_healthCheckInterval = 30;

   private int m_maxErrorCounter = 3;

   private String m_cookieDomain = ".dianping.com";

   private String m_cookieName = "_zd_";

   private int m_retryTimes = 0;

   private String m_encryptSeed = "2123174217368174103L";

   private int m_cookieExpiredTime = 2;

   private String m_globalBlackList = "";

   private String m_appBlackList = "";
   ...
   public boolean equals(Object obj) {
      if (obj instanceof SystemConfig) {
         ...
         result &= (m_globalBlackList == globalBlackList || m_globalBlackList != null && m_globalBlackList.equals(globalBlackList));
