...
public class DefaultXmlBuilder implements IVisitor {
   ...
   public void visitDataSourceConfig(DataSourceConfig dataSourceConfig) {
      startTag(ENTITY_DATA_SOURCE_CONFIG, null, ATTR_ID, dataSourceConfig.getId(), ATTR_WEIGHT, dataSourceConfig.getWeight(), ATTR_CANREAD, dataSourceConfig.isCanRead(), ATTR_CANWRITE, dataSourceConfig.isCanWrite(), ATTR_ACTIVE, dataSourceConfig.isActive());
   ...
   public void visitGroupDataSourceConfig(GroupDataSourceConfig groupDataSourceConfig) {
      startTag(ENTITY_GROUP_DATA_SOURCE_CONFIG, null, ATTR_ROUTER_STRATEGY, groupDataSourceConfig.getRouterStrategy(), ATTR_TRANSACTION_FORCE_WRITE, groupDataSourceConfig.isTransactionForceWrite(), ATTR_WRITE_FIRST, groupDataSourceConfig.isWriteFirst(), ATTR_FILTERS, groupDataSourceConfig.getFilters());
