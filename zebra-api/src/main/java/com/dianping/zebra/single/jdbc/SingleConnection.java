...
public class SingleConnection implements Connection {
	...
	public Statement createStatement() throws SQLException {
		...
		return new SingleStatement(this.dataSource.getId(), conn, this.filters, stmt);
	}
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		...
		return new SinglePreparedStatement(this.dataSource.getId(), conn, filters, pstmt, sql);
	}
