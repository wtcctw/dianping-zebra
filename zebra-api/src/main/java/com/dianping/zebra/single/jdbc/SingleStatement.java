...
public class SingleStatement implements Statement {
	...
	public SingleStatement(String dsId, Connection innerConnection, Statement innnerStatement, List<JdbcFilter> filters)
			throws SQLException {
		this.dsId = dsId;
	...
	public ResultSet executeQuery(final String sql) throws SQLException {
		...
		return executeWithFilter(new JdbcOperationCallback<ResultSet>() {
			...
			public ResultSet doAction(Connection conn) throws SQLException {
				return innerStatement.executeQuery(processedSql);
			}
		}, sql, null, false);
	}
