// $ANTLR 3.5.2 MySQLParser.g 2015-06-03 18:01:45
...
public class MySQLParserParser extends Parser {
	...
	public final MySQLParserParser.setclause_return setclause() throws RecognitionException {
		...
		try {
			...
			{
			string_literal6=(Token)match(input,110,FOLLOW_110_in_setclause278); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_110.add(string_literal6);
	...
	public final MySQLParserParser.insert_command_return insert_command() throws RecognitionException {
		...
		Token LPAREN21=null;
		Token RPAREN23=null;
		ParserRuleReturnScope selected_table16 =null;
		ParserRuleReturnScope column_specs18 =null;
		ParserRuleReturnScope values22 =null;
		...
		try {
			...
			{
			string_literal14=(Token)match(input,94,FOLLOW_94_in_insert_command335); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_94.add(string_literal14);

			string_literal15=(Token)match(input,95,FOLLOW_95_in_insert_command337); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_95.add(string_literal15);
			...
			{
			string_literal20=(Token)match(input,113,FOLLOW_113_in_insert_command358); if (state.failed) return retval; 
	...
	public final MySQLParserParser.orderByClause_return orderByClause() throws RecognitionException {
		...
		ParserRuleReturnScope columnNamesAfterWhere26 =null;
		...
		try {
			...
			{
			string_literal24=(Token)match(input,106,FOLLOW_106_in_orderByClause393); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_106.add(string_literal24);

			string_literal25=(Token)match(input,80,FOLLOW_80_in_orderByClause395); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_80.add(string_literal25);
	...
	public final MySQLParserParser.columnNamesAfterWhere_return columnNamesAfterWhere() throws RecognitionException {
		...
		Token COMMA28=null;
		ParserRuleReturnScope columnNameAfterWhere27 =null;
		ParserRuleReturnScope columnNameAfterWhere29 =null;
	...
	public final MySQLParserParser.selectClause_return selectClause() throws RecognitionException {
		...
		Token LPAREN32=null;
		Token RPAREN34=null;
		ParserRuleReturnScope distinct31 =null;
		ParserRuleReturnScope select_list33 =null;
		...
		try {
			...
			{
			string_literal30=(Token)match(input,109,FOLLOW_109_in_selectClause441); if (state.failed) return retval; 
	...
	public final MySQLParserParser.whereClause_return whereClause() throws RecognitionException {
		...
		ParserRuleReturnScope sqlCondition36 =null;
		...
		try {
			...
			{
			string_literal35=(Token)match(input,114,FOLLOW_114_in_whereClause476); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_114.add(string_literal35);
	...
	public final MySQLParserParser.sqlCondition_return sqlCondition() throws RecognitionException {
		...
		ParserRuleReturnScope condition_or38 =null;
		...
		try {
			...
			else if ( (LA8_0==ASTERISK||LA8_0==DOUBLEQUOTED_STRING||LA8_0==ID||LA8_0==LPAREN||LA8_0==MINUS||LA8_0==N||LA8_0==NUMBER||LA8_0==PLUS||LA8_0==QUOTED_STRING||LA8_0==76||LA8_0==85||LA8_0==103||LA8_0==108||LA8_0==111) ) {
				alt8=2;
			}
			...
			switch (alt8) {
				case 1 :
					...
					{
					string_literal37=(Token)match(input,102,FOLLOW_102_in_sqlCondition494); if (state.failed) return retval; 
	...
	public final MySQLParserParser.condition_or_return condition_or() throws RecognitionException {
		...
		ParserRuleReturnScope condition_and40 =null;
		ParserRuleReturnScope condition_and42 =null;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					string_literal41=(Token)match(input,105,FOLLOW_105_in_condition_or529); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.condition_and_return condition_and() throws RecognitionException {
		...
		ParserRuleReturnScope condition_PAREN43 =null;
		ParserRuleReturnScope condition_PAREN45 =null;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					string_literal44=(Token)match(input,77,FOLLOW_77_in_condition_and549); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.condition_PAREN_return condition_PAREN() throws RecognitionException {
		...
		Token LPAREN46=null;
		Token RPAREN48=null;
		ParserRuleReturnScope condition_or47 =null;
		ParserRuleReturnScope condition_expr49 =null;
		...
		try {
			...
			else if ( (LA11_0==ASTERISK||LA11_0==DOUBLEQUOTED_STRING||LA11_0==ID||LA11_0==MINUS||LA11_0==N||LA11_0==NUMBER||LA11_0==PLUS||LA11_0==QUOTED_STRING||LA11_0==76||LA11_0==85||LA11_0==103||LA11_0==108||LA11_0==111) ) {
				alt11=2;
			}
	...
	public final MySQLParserParser.condition_expr_return condition_expr() throws RecognitionException {
		...
		ParserRuleReturnScope condition_left50 =null;
		ParserRuleReturnScope comparisonCondition51 =null;
		ParserRuleReturnScope inCondition52 =null;
		ParserRuleReturnScope isCondition53 =null;
		ParserRuleReturnScope likeCondition54 =null;
		ParserRuleReturnScope betweenCondition55 =null;
	...
	public final MySQLParserParser.betweenCondition_return betweenCondition() throws RecognitionException {
		...
		ParserRuleReturnScope between_and59 =null;
		ParserRuleReturnScope between_and61 =null;
		...
		try {
			...
			switch (alt13) {
				case 1 :
					...
					{
					string_literal57=(Token)match(input,102,FOLLOW_102_in_betweenCondition655); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_102.add(string_literal57);

					string_literal58=(Token)match(input,79,FOLLOW_79_in_betweenCondition657); if (state.failed) return retval; 
				...
				case 2 :
					...
					{
					string_literal60=(Token)match(input,79,FOLLOW_79_in_betweenCondition670); if (state.failed) return retval; 
	...
	public final MySQLParserParser.between_and_return between_and() throws RecognitionException {
		...
		try {
			...
			string_literal62=(Token)match(input,77,FOLLOW_77_in_between_and693); if (state.failed) return retval; 
	...
	public final MySQLParserParser.between_and_expression_return between_and_expression() throws RecognitionException {
		...
		ParserRuleReturnScope quoted_string63 =null;
		ParserRuleReturnScope expr_add64 =null;
		...
		try {
			...
			if ( (LA14_0==DOUBLEQUOTED_STRING||LA14_0==QUOTED_STRING) ) {
				alt14=1;
			}
			else if ( (LA14_0==ASTERISK||LA14_0==ID||LA14_0==LPAREN||LA14_0==MINUS||LA14_0==N||LA14_0==NUMBER||LA14_0==PLUS||LA14_0==76||LA14_0==85||LA14_0==103||LA14_0==108||LA14_0==111) ) {
				alt14=2;
			}
	...
	public final MySQLParserParser.isCondition_return isCondition() throws RecognitionException {
		...
		ParserRuleReturnScope condition_is_valobject67 =null;
		ParserRuleReturnScope condition_is_valobject69 =null;
		...
		try {
			...
			if ( (LA15_0==96) ) {
				...
				else if ( (LA15_1==92||LA15_1==101||LA15_1==103) ) {
					alt15=2;
				}
			...
			switch (alt15) {
				case 1 :
					...
					{
					string_literal65=(Token)match(input,96,FOLLOW_96_in_isCondition734); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_96.add(string_literal65);

					string_literal66=(Token)match(input,102,FOLLOW_102_in_isCondition736); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_102.add(string_literal66);
				...
				case 2 :
					...
					{
					string_literal68=(Token)match(input,96,FOLLOW_96_in_isCondition748); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_96.add(string_literal68);
		...
		try {
			...
			switch (alt16) {
				case 1 :
					...
					{
					string_literal70=(Token)match(input,101,FOLLOW_101_in_condition_is_valobject768); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_101.add(string_literal70);
				...
				case 2 :
					...
					{
					string_literal71=(Token)match(input,92,FOLLOW_92_in_condition_is_valobject776); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_92.add(string_literal71);
				...
				case 3 :
					...
					{
					string_literal72=(Token)match(input,103,FOLLOW_103_in_condition_is_valobject784); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_103.add(string_literal72);
	...
	public final MySQLParserParser.inCondition_return inCondition() throws RecognitionException {
		...
		Token LPAREN75=null;
		Token RPAREN77=null;
		ParserRuleReturnScope subquery74 =null;
		ParserRuleReturnScope inCondition_expr_adds76 =null;
		...
		try {
			...
			switch (alt17) {
				case 1 :
					...
					{
					not=(Token)match(input,102,FOLLOW_102_in_inCondition800); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_102.add(not);
			...
			string_literal73=(Token)match(input,90,FOLLOW_90_in_inCondition804); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_90.add(string_literal73);
			...
			if ( (LA18_0==LPAREN) ) {
				...
				else if ( (LA18_1==ASTERISK||LA18_1==DOUBLEQUOTED_STRING||LA18_1==ID||LA18_1==LPAREN||LA18_1==MINUS||LA18_1==N||LA18_1==NUMBER||LA18_1==PLUS||LA18_1==QUOTED_STRING||LA18_1==76||LA18_1==85||LA18_1==103||LA18_1==108||LA18_1==111) ) {
					alt18=2;
				}
			...
			// AST REWRITE
			// elements: subquery, inCondition_expr_adds, not
			// token labels: not
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
		...
		try {
			...
			switch (alt19) {
				case 1 :
					...
					{
					string_literal78=(Token)match(input,102,FOLLOW_102_in_likeCondition844); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_102.add(string_literal78);

					string_literal79=(Token)match(input,99,FOLLOW_99_in_likeCondition845); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_99.add(string_literal79);
				...
				case 2 :
					...
					{
					string_literal81=(Token)match(input,99,FOLLOW_99_in_likeCondition858); if (state.failed) return retval; 
	...
	public final MySQLParserParser.inCondition_expr_adds_return inCondition_expr_adds() throws RecognitionException {
		...
		Token COMMA84=null;
		ParserRuleReturnScope expr_add83 =null;
		ParserRuleReturnScope expr_add85 =null;
	...
	public final MySQLParserParser.identifiers_return identifiers() throws RecognitionException {
		...
		Token COMMA87=null;
		ParserRuleReturnScope columnNameAfterWhere86 =null;
	...
	public final MySQLParserParser.comparisonCondition_return comparisonCondition() throws RecognitionException {
		...
		ParserRuleReturnScope relational_op89 =null;
	...
	public final MySQLParserParser.expr_return expr() throws RecognitionException {
		...
		ParserRuleReturnScope expr_add91 =null;
		ParserRuleReturnScope subquery92 =null;
		...
		try {
			...
			if ( (LA22_0==ASTERISK||LA22_0==DOUBLEQUOTED_STRING||LA22_0==ID||LA22_0==MINUS||LA22_0==N||LA22_0==NUMBER||LA22_0==PLUS||LA22_0==QUOTED_STRING||LA22_0==76||LA22_0==85||LA22_0==103||LA22_0==108||LA22_0==111) ) {
				alt22=1;
			}
			else if ( (LA22_0==LPAREN) ) {
				int LA22_2 = input.LA(2);
				if ( (LA22_2==ASTERISK||LA22_2==DOUBLEQUOTED_STRING||LA22_2==ID||LA22_2==LPAREN||LA22_2==MINUS||LA22_2==N||LA22_2==NUMBER||LA22_2==PLUS||LA22_2==QUOTED_STRING||LA22_2==76||LA22_2==85||LA22_2==103||LA22_2==108||LA22_2==111) ) {
					alt22=1;
				}
				else if ( (LA22_2==109) ) {
					alt22=2;
	...
	public final MySQLParserParser.subquery_return subquery() throws RecognitionException {
		...
		Token LPAREN93=null;
		Token RPAREN95=null;
		ParserRuleReturnScope select_command94 =null;
	...
	public final MySQLParserParser.expr_add_return expr_add() throws RecognitionException {
		...
		ParserRuleReturnScope expr_mul96 =null;
		ParserRuleReturnScope expr_mul100 =null;
		...
		try {
			...
			while (true) {
				...
				if ( (LA24_0==DOUBLEVERTBAR||LA24_0==MINUS||LA24_0==PLUS) ) {
					alt24=1;
				}
	...
	public final MySQLParserParser.expr_mul_return expr_mul() throws RecognitionException {
		...
		Token MOD104=null;
		ParserRuleReturnScope expr_sign101 =null;
		ParserRuleReturnScope expr_sign105 =null;
		...
		try {
			...
			while (true) {
				...
				if ( (LA26_0==ASTERISK) ) {
					...
					if ( (LA26_2==ASTERISK||LA26_2==DOUBLEQUOTED_STRING||LA26_2==ID||LA26_2==LPAREN||LA26_2==MINUS||LA26_2==N||LA26_2==NUMBER||LA26_2==PLUS||LA26_2==QUOTED_STRING||LA26_2==76||LA26_2==85||LA26_2==103||LA26_2==108||LA26_2==111) ) {
						alt26=1;
					}
	...
	public final MySQLParserParser.expr_sign_return expr_sign() throws RecognitionException {
		...
		Token PLUS106=null;
		Token MINUS107=null;
		ParserRuleReturnScope expr_pow108 =null;
	...
	public final MySQLParserParser.expr_pow_return expr_pow() throws RecognitionException {
		...
		ParserRuleReturnScope expr_expr109 =null;
		ParserRuleReturnScope expr_expr111 =null;
	...
	public final MySQLParserParser.expr_expr_return expr_expr() throws RecognitionException {
		...
		ParserRuleReturnScope value112 =null;
		ParserRuleReturnScope boolean_literal113 =null;
		ParserRuleReturnScope values_func118 =null;
		...
		try {
			...
			switch (alt31) {
				...
				case 3 :
					...
					string_literal114=(Token)match(input,103,FOLLOW_103_in_expr_expr1107); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
				...
				case 4 :
					...
					string_literal115=(Token)match(input,108,FOLLOW_108_in_expr_expr1111); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
				...
				case 5 :
					...
					else if ( (LA30_0==EOF||LA30_0==ASTERISK||LA30_0==COMMA||LA30_0==DIVIDE||(LA30_0 >= DOUBLEVERTBAR && LA30_0 <= EXPONENT)||LA30_0==GEQ||(LA30_0 >= GTH && LA30_0 <= ID)||LA30_0==LEQ||(LA30_0 >= LTH && LA30_0 <= MOD)||LA30_0==NOT_EQ||LA30_0==PLUS||LA30_0==RPAREN||(LA30_0 >= 77 && LA30_0 <= 79)||(LA30_0 >= 86 && LA30_0 <= 90)||LA30_0==93||(LA30_0 >= 96 && LA30_0 <= 100)||LA30_0==102||(LA30_0 >= 105 && LA30_0 <= 107)||LA30_0==114) ) {
						alt30=2;
					}
					...
					switch (alt30) {
						case 1 :
							...
							if ( (LA29_0==ASTERISK||LA29_0==DOUBLEQUOTED_STRING||LA29_0==ID||LA29_0==LPAREN||LA29_0==MINUS||LA29_0==N||LA29_0==NUMBER||LA29_0==PLUS||LA29_0==QUOTED_STRING||LA29_0==76||LA29_0==85||LA29_0==103||LA29_0==108||LA29_0==111) ) {
								alt29=1;
							}
							switch (alt29) {
								case 1 :
	...
	public final MySQLParserParser.sql_condition_return sql_condition() throws RecognitionException {
		...
		ParserRuleReturnScope condition_or120 =null;
	...
	public final MySQLParserParser.fromClause_return fromClause() throws RecognitionException {
		...
		ParserRuleReturnScope selected_table123 =null;
		...
		try {
			...
			string_literal122=(Token)match(input,87,FOLLOW_87_in_fromClause1190); if (state.failed) return retval;
	...
	public final MySQLParserParser.select_list_return select_list() throws RecognitionException {
		...
		Token COMMA125=null;
		ParserRuleReturnScope displayed_column124 =null;
		ParserRuleReturnScope displayed_column126 =null;
	...
	public final MySQLParserParser.displayed_column_return displayed_column() throws RecognitionException {
		...
		ParserRuleReturnScope quoted_string127 =null;
		ParserRuleReturnScope alias128 =null;
		ParserRuleReturnScope concat129 =null;
		ParserRuleReturnScope identifiedOrQuotedString131 =null;
		ParserRuleReturnScope identifiedOrQuotedString133 =null;
		ParserRuleReturnScope alias135 =null;
		ParserRuleReturnScope count136 =null;
		ParserRuleReturnScope distinct138 =null;
		ParserRuleReturnScope countColumn140 =null;
		ParserRuleReturnScope alias143 =null;
		ParserRuleReturnScope expr_add144 =null;
		ParserRuleReturnScope alias145 =null;
		ParserRuleReturnScope table_alias148 =null;
		ParserRuleReturnScope column149 =null;
		ParserRuleReturnScope alias151 =null;
		...
		try {
			...
			switch (alt45) {
				case 1 :
					...
					if ( (LA33_0==ASTERISK||LA33_0==ID||LA33_0==78) ) {
						alt33=1;
					}
					switch (alt33) {
						case 1 :
				...
				case 2 :
					...
					if ( (LA35_0==ASTERISK||LA35_0==ID||LA35_0==78) ) {
						alt35=1;
					}
					switch (alt35) {
						case 1 :
					...
					// AST REWRITE
					// elements: alias, identifiedOrQuotedString, concat, identifiedOrQuotedString
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 3 :
					...
					if ( (LA39_0==ASTERISK||LA39_0==ID||LA39_0==78) ) {
						alt39=1;
					}
					switch (alt39) {
						case 1 :
					...
					// AST REWRITE
					// elements: distinct, count, alias, countColumn
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
				...
				case 4 :
					...
					if ( (LA40_0==ASTERISK||LA40_0==ID||LA40_0==78) ) {
						alt40=1;
					}
					switch (alt40) {
						case 1 :
				...
				case 5 :
					...
					else if ( (LA43_0==EOF||LA43_0==ASTERISK||LA43_0==COMMA||LA43_0==ID||LA43_0==RPAREN||LA43_0==78||(LA43_0 >= 86 && LA43_0 <= 89)||LA43_0==93||(LA43_0 >= 97 && LA43_0 <= 98)||LA43_0==100||(LA43_0 >= 106 && LA43_0 <= 107)||LA43_0==114) ) {
						alt43=2;
					}
					...
					if ( (LA44_0==ASTERISK||LA44_0==ID||LA44_0==78) ) {
						alt44=1;
					}
					switch (alt44) {
						case 1 :
					...
					// AST REWRITE
					// elements: column, ID, alias, table_alias
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final MySQLParserParser.columnNameAfterWhere_return columnNameAfterWhere() throws RecognitionException {
		...
		Token ASC156=null;
		Token DESC159=null;
		ParserRuleReturnScope table_alias152 =null;
		ParserRuleReturnScope identifier153 =null;
		ParserRuleReturnScope table_alias154 =null;
		ParserRuleReturnScope identifier155 =null;
		ParserRuleReturnScope table_alias157 =null;
	...
	public final MySQLParserParser.columnNameInUpdate_return columnNameInUpdate() throws RecognitionException {
		...
		ParserRuleReturnScope table_alias160 =null;
	...
	public final MySQLParserParser.value_return value() throws RecognitionException {
		...
		ParserRuleReturnScope quoted_string178 =null;
		ParserRuleReturnScope column_spec179 =null;
		...
		try {
			...
			switch (alt54) {
				...
				case 3 :
					...
					char_literal174=(Token)match(input,76,FOLLOW_76_in_value1545); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.value_simple_return value_simple() throws RecognitionException {
		...
		ParserRuleReturnScope quoted_string186 =null;
		ParserRuleReturnScope column_spec187 =null;
		...
		try {
			...
			switch (alt55) {
				...
				case 3 :
					...
					char_literal182=(Token)match(input,76,FOLLOW_76_in_value_simple1588); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.column_specs_return column_specs() throws RecognitionException {
		...
		ParserRuleReturnScope column_spec190 =null;
	...
	public final MySQLParserParser.selected_table_return selected_table() throws RecognitionException {
		...
		Token COMMA192=null;
		ParserRuleReturnScope a_table191 =null;
		ParserRuleReturnScope a_table193 =null;
	...
	public final MySQLParserParser.a_table_return a_table() throws RecognitionException {
		...
		ParserRuleReturnScope table_spec194 =null;
		ParserRuleReturnScope alias195 =null;
		...
		try {
			...
			if ( (LA58_0==ASTERISK||LA58_0==ID||LA58_0==78) ) {
				alt58=1;
			}
			switch (alt58) {
				case 1 :
	...
	public final MySQLParserParser.table_spec_return table_spec() throws RecognitionException {
		...
		Token DOT197=null;
		ParserRuleReturnScope schema_name196 =null;
		ParserRuleReturnScope table_name198 =null;
	...
	public final MySQLParserParser.column_spec_return column_spec() throws RecognitionException {
		...
		Token DOT202=null;
		ParserRuleReturnScope table_name201 =null;
	...
	public final MySQLParserParser.boolean_literal_return boolean_literal() throws RecognitionException {
		...
		try {
			...
			set205=input.LT(1);
			if ( input.LA(1)==85||input.LA(1)==111 ) {
				input.consume();
	...
	public final MySQLParserParser.alias_return alias() throws RecognitionException {
		...
		ParserRuleReturnScope identifier207 =null;
		...
		try {
			...
			switch (alt62) {
				case 1 :
					...
					{
					string_literal206=(Token)match(input,78,FOLLOW_78_in_alias1789); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_78.add(string_literal206);
	...
	public final MySQLParserParser.select_command_return select_command() throws RecognitionException {
		...
		ParserRuleReturnScope selectClause210 =null;
		ParserRuleReturnScope fromClause211 =null;
		ParserRuleReturnScope joinClause212 =null;
		ParserRuleReturnScope whereClause213 =null;
		ParserRuleReturnScope groupByClause214 =null;
		ParserRuleReturnScope orderByClause215 =null;
		ParserRuleReturnScope limitClause216 =null;
		ParserRuleReturnScope indexClause217 =null;
		...
		try {
			...
			while (true) {
				...
				if ( (LA64_0==93||(LA64_0 >= 97 && LA64_0 <= 98)||LA64_0==107) ) {
					alt64=1;
				}
	...
	public final MySQLParserParser.groupByClause_return groupByClause() throws RecognitionException {
		...
		ParserRuleReturnScope groupByColumns219 =null;
		...
		try {
			...
			{
			string_literal218=(Token)match(input,88,FOLLOW_88_in_groupByClause2389); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_88.add(string_literal218);
	...
	public final MySQLParserParser.groupByColumns_return groupByColumns() throws RecognitionException {
		...
		Token COMMA221=null;
		ParserRuleReturnScope groupByColumn220 =null;
		ParserRuleReturnScope groupByColumn222 =null;
	...
	public final MySQLParserParser.indexClause_return indexClause() throws RecognitionException {
		...
		ParserRuleReturnScope select_list227 =null;
		ParserRuleReturnScope select_list232 =null;
		...
		try {
			...
			switch (alt71) {
				case 1 :
					...
					string_literal224=(Token)match(input,86,FOLLOW_86_in_indexClause2436); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					string_literal224_tree = (CommonTree)adaptor.create(string_literal224);
					adaptor.addChild(root_0, string_literal224_tree);
					}

					string_literal225=(Token)match(input,91,FOLLOW_91_in_indexClause2438); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
				...
				case 2 :
					...
					string_literal229=(Token)match(input,89,FOLLOW_89_in_indexClause2450); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
					string_literal229_tree = (CommonTree)adaptor.create(string_literal229);
					adaptor.addChild(root_0, string_literal229_tree);
					}

					string_literal230=(Token)match(input,91,FOLLOW_91_in_indexClause2452); if (state.failed) return retval;
					if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.delete_command_return delete_command() throws RecognitionException {
		...
		ParserRuleReturnScope fromClause235 =null;
		ParserRuleReturnScope whereClause236 =null;
		ParserRuleReturnScope orderByClause237 =null;
		ParserRuleReturnScope limitClause238 =null;
		...
		try {
			...
			{
			string_literal234=(Token)match(input,83,FOLLOW_83_in_delete_command2468); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_83.add(string_literal234);
			...
			// AST REWRITE
			// elements: fromClause, whereClause, limitClause, orderByClause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final MySQLParserParser.update_command_return update_command() throws RecognitionException {
		...
		ParserRuleReturnScope selected_table240 =null;
		ParserRuleReturnScope setclause241 =null;
		ParserRuleReturnScope whereClause242 =null;
		ParserRuleReturnScope limitClause243 =null;
		...
		try {
			...
			{
			string_literal239=(Token)match(input,112,FOLLOW_112_in_update_command2506); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_112.add(string_literal239);
			...
			// AST REWRITE
			// elements: setclause, whereClause, selected_table, limitClause
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final MySQLParserParser.limitClause_return limitClause() throws RecognitionException {
		...
		Token COMMA246=null;
		ParserRuleReturnScope skip245 =null;
		ParserRuleReturnScope range247 =null;
		...
		try {
			...
			{
			string_literal244=(Token)match(input,100,FOLLOW_100_in_limitClause2543); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_100.add(string_literal244);
		...
		try {
			...
			switch (alt78) {
				...
				case 2 :
					// MySQLParser.g:509:3: '?'
					{
					char_literal249=(Token)match(input,76,FOLLOW_76_in_skip2583); if (state.failed) return retval; 
		...
		try {
			...
			switch (alt79) {
				...
				case 2 :
					// MySQLParser.g:512:3: '?'
					{
					char_literal251=(Token)match(input,76,FOLLOW_76_in_range2607); if (state.failed) return retval; 
					if ( state.backtracking==0 ) stream_76.add(char_literal251);
	...
	public final MySQLParserParser.joinClause_return joinClause() throws RecognitionException {
		...
		ParserRuleReturnScope joinType252 =null;
		ParserRuleReturnScope table_spec253 =null;
		ParserRuleReturnScope alias254 =null;
		ParserRuleReturnScope sqlCondition256 =null;
		...
		try {
			...
			if ( (LA80_0==ASTERISK||LA80_0==ID||LA80_0==78) ) {
				alt80=1;
			}
			switch (alt80) {
				case 1 :
			...
			string_literal255=(Token)match(input,104,FOLLOW_104_in_joinClause2630); if (state.failed) return retval; 
			if ( state.backtracking==0 ) stream_104.add(string_literal255);
			...
			// AST REWRITE
			// elements: 104, table_spec, alias, joinType, sqlCondition
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final MySQLParserParser.concat_return concat() throws RecognitionException {
		...
		try {
			...
			string_literal258=(Token)match(input,81,FOLLOW_81_in_concat2677); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.identifiedOrQuotedString_return identifiedOrQuotedString() throws RecognitionException {
		...
		ParserRuleReturnScope table_alias259 =null;
		...
		try {
			...
			else if ( (LA82_0==DOUBLEQUOTED_STRING||LA82_0==QUOTED_STRING) ) {
				alt82=2;
			}
	...
	public final MySQLParserParser.distinct_return distinct() throws RecognitionException {
		...
		try {
			...
			string_literal262=(Token)match(input,84,FOLLOW_84_in_distinct2710); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.count_return count() throws RecognitionException {
		...
		try {
			...
			string_literal263=(Token)match(input,82,FOLLOW_82_in_count2720); if (state.failed) return retval;
			if ( state.backtracking==0 ) {
	...
	public final MySQLParserParser.identifierOrN_return identifierOrN() throws RecognitionException {
		...
		Token N265=null;
		ParserRuleReturnScope identifier264 =null;
	...
	public final MySQLParserParser.countColumn_return countColumn() throws RecognitionException {
		...
		Token DOT267=null;
		ParserRuleReturnScope identifier266 =null;
		ParserRuleReturnScope identifierOrN268 =null;
	...
	public static final BitSet FOLLOW_110_in_setclause278 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_updateColumnSpecs_in_setclause280 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_updateColumnSpec_in_updateColumnSpecs297 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_updateColumnSpecs300 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_updateColumnSpec_in_updateColumnSpecs302 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_columnNameInUpdate_in_updateColumnSpec320 = new BitSet(new long[]{0x0000000008000000L});
	public static final BitSet FOLLOW_EQ_in_updateColumnSpec322 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_in_updateColumnSpec325 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_94_in_insert_command335 = new BitSet(new long[]{0x0000000000000000L,0x0000000080000000L});
	public static final BitSet FOLLOW_95_in_insert_command337 = new BitSet(new long[]{0x0000100200000200L});
	public static final BitSet FOLLOW_selected_table_in_insert_command339 = new BitSet(new long[]{0x0000100000000000L,0x0002000000000000L});
	public static final BitSet FOLLOW_LPAREN_in_insert_command345 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_column_specs_in_insert_command347 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_insert_command350 = new BitSet(new long[]{0x0000000000000000L,0x0002000000000000L});
	public static final BitSet FOLLOW_113_in_insert_command358 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_LPAREN_in_insert_command360 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_values_in_insert_command362 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_insert_command364 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_106_in_orderByClause393 = new BitSet(new long[]{0x0000000000000000L,0x0000000000010000L});
	public static final BitSet FOLLOW_80_in_orderByClause395 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_columnNamesAfterWhere_in_orderByClause397 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_columnNameAfterWhere_in_columnNamesAfterWhere417 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_columnNamesAfterWhere420 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_columnNameAfterWhere_in_columnNamesAfterWhere423 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_109_in_selectClause441 = new BitSet(new long[]{0x2481500202000200L,0x0000908000361000L});
	public static final BitSet FOLLOW_distinct_in_selectClause443 = new BitSet(new long[]{0x2481500202000200L,0x0000908000261000L});
	public static final BitSet FOLLOW_LPAREN_in_selectClause446 = new BitSet(new long[]{0x2481500202000200L,0x0000908000261000L});
	public static final BitSet FOLLOW_select_list_in_selectClause449 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_selectClause451 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_114_in_whereClause476 = new BitSet(new long[]{0x2481500202000200L,0x000090C000201000L});
	public static final BitSet FOLLOW_sqlCondition_in_whereClause478 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_102_in_sqlCondition494 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	...
	public static final BitSet FOLLOW_condition_and_in_condition_or525 = new BitSet(new long[]{0x0000000000000002L,0x0000020000000000L});
	public static final BitSet FOLLOW_105_in_condition_or529 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_condition_and_in_condition_or532 = new BitSet(new long[]{0x0000000000000002L,0x0000020000000000L});
	public static final BitSet FOLLOW_condition_PAREN_in_condition_and545 = new BitSet(new long[]{0x0000000000000002L,0x0000000000002000L});
	public static final BitSet FOLLOW_77_in_condition_and549 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_condition_PAREN_in_condition_and552 = new BitSet(new long[]{0x0000000000000002L,0x0000000000002000L});
	public static final BitSet FOLLOW_LPAREN_in_condition_PAREN572 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_condition_or_in_condition_PAREN574 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	...
	public static final BitSet FOLLOW_condition_left_in_condition_expr596 = new BitSet(new long[]{0x0010240148000000L,0x0000004904008000L});
	...
	public static final BitSet FOLLOW_102_in_betweenCondition655 = new BitSet(new long[]{0x0000000000000000L,0x0000000000008000L});
	public static final BitSet FOLLOW_79_in_betweenCondition657 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_between_and_in_betweenCondition659 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_79_in_betweenCondition670 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_between_and_in_betweenCondition672 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_between_and_expression_in_between_and691 = new BitSet(new long[]{0x0000000000000000L,0x0000000000002000L});
	public static final BitSet FOLLOW_77_in_between_and693 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	...
	public static final BitSet FOLLOW_96_in_isCondition734 = new BitSet(new long[]{0x0000000000000000L,0x0000004000000000L});
	public static final BitSet FOLLOW_102_in_isCondition736 = new BitSet(new long[]{0x0000000000000000L,0x000000A010000000L});
	public static final BitSet FOLLOW_condition_is_valobject_in_isCondition738 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_96_in_isCondition748 = new BitSet(new long[]{0x0000000000000000L,0x000000A010000000L});
	public static final BitSet FOLLOW_condition_is_valobject_in_isCondition750 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_101_in_condition_is_valobject768 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_92_in_condition_is_valobject776 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_103_in_condition_is_valobject784 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_102_in_inCondition800 = new BitSet(new long[]{0x0000000000000000L,0x0000000004000000L});
	public static final BitSet FOLLOW_90_in_inCondition804 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_subquery_in_inCondition807 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_inCondition813 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_inCondition_expr_adds_in_inCondition815 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_inCondition817 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_102_in_likeCondition844 = new BitSet(new long[]{0x0000000000000000L,0x0000000800000000L});
	public static final BitSet FOLLOW_99_in_likeCondition845 = new BitSet(new long[]{0x2081100202000200L,0x0000000000001000L});
	public static final BitSet FOLLOW_value_in_likeCondition848 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_99_in_likeCondition858 = new BitSet(new long[]{0x2081100202000200L,0x0000000000001000L});
	public static final BitSet FOLLOW_value_in_likeCondition860 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_add_in_inCondition_expr_adds877 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_inCondition_expr_adds879 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_add_in_inCondition_expr_adds881 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_columnNameAfterWhere_in_identifiers901 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_identifiers904 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_identifiers906 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_relational_op_in_comparisonCondition918 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	...
	public static final BitSet FOLLOW_LPAREN_in_subquery960 = new BitSet(new long[]{0x0000000000000000L,0x0000200000000000L});
	public static final BitSet FOLLOW_select_command_in_subquery962 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_subquery964 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_mul_in_expr_add980 = new BitSet(new long[]{0x0400400004000002L});
	public static final BitSet FOLLOW_PLUS_in_expr_add986 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_MINUS_in_expr_add991 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_DOUBLEVERTBAR_in_expr_add996 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_mul_in_expr_add1002 = new BitSet(new long[]{0x0400400004000002L});
	public static final BitSet FOLLOW_expr_sign_in_expr_mul1022 = new BitSet(new long[]{0x0000800000800202L});
	public static final BitSet FOLLOW_ASTERISK_in_expr_mul1028 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_DIVIDE_in_expr_mul1033 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_MOD_in_expr_mul1038 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_sign_in_expr_mul1043 = new BitSet(new long[]{0x0000800000800202L});
	public static final BitSet FOLLOW_PLUS_in_expr_sign1058 = new BitSet(new long[]{0x2081100202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_MINUS_in_expr_sign1063 = new BitSet(new long[]{0x2081100202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_pow_in_expr_sign1069 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_expr_in_expr_pow1079 = new BitSet(new long[]{0x0000000010000002L});
	public static final BitSet FOLLOW_EXPONENT_in_expr_pow1083 = new BitSet(new long[]{0x2081100202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_expr_in_expr_pow1086 = new BitSet(new long[]{0x0000000010000002L});
	...
	public static final BitSet FOLLOW_103_in_expr_expr1107 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_108_in_expr_expr1111 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_expr_expr1119 = new BitSet(new long[]{0x0000100000000002L});
	public static final BitSet FOLLOW_LPAREN_in_expr_expr1123 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201001L});
	public static final BitSet FOLLOW_values_func_in_expr_expr1125 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	...
	public static final BitSet FOLLOW_87_in_fromClause1190 = new BitSet(new long[]{0x0000100200000200L});
	public static final BitSet FOLLOW_selected_table_in_fromClause1193 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_displayed_column_in_select_list1204 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_select_list1208 = new BitSet(new long[]{0x2481500202000200L,0x0000908000261000L});
	public static final BitSet FOLLOW_displayed_column_in_select_list1210 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_quoted_string_in_displayed_column1233 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_displayed_column1235 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_concat_in_displayed_column1249 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_LPAREN_in_displayed_column1251 = new BitSet(new long[]{0x2000000202000200L});
	public static final BitSet FOLLOW_identifiedOrQuotedString_in_displayed_column1253 = new BitSet(new long[]{0x0000000000004000L,0x0000000000000001L});
	public static final BitSet FOLLOW_COMMA_in_displayed_column1256 = new BitSet(new long[]{0x2000000202000200L});
	public static final BitSet FOLLOW_identifiedOrQuotedString_in_displayed_column1258 = new BitSet(new long[]{0x0000000000004000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_displayed_column1262 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_displayed_column1264 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_count_in_displayed_column1285 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_LPAREN_in_displayed_column1287 = new BitSet(new long[]{0x0001100200000200L,0x0000000000100000L});
	public static final BitSet FOLLOW_distinct_in_displayed_column1289 = new BitSet(new long[]{0x0001100200000200L});
	public static final BitSet FOLLOW_LPAREN_in_displayed_column1292 = new BitSet(new long[]{0x0001000200000200L});
	public static final BitSet FOLLOW_countColumn_in_displayed_column1295 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_displayed_column1297 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_displayed_column1300 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_displayed_column1302 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expr_add_in_displayed_column1319 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_displayed_column1321 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_displayed_column1339 = new BitSet(new long[]{0x0000100200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_LPAREN_in_displayed_column1343 = new BitSet(new long[]{0x0000000200000200L,0x0000000000000001L});
	public static final BitSet FOLLOW_table_alias_in_displayed_column1345 = new BitSet(new long[]{0x0000000200000200L,0x0000000000000001L});
	public static final BitSet FOLLOW_column_in_displayed_column1348 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_displayed_column1351 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_displayed_column1356 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_alias_in_columnNameAfterWhere1381 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_columnNameAfterWhere1384 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_alias_in_columnNameAfterWhere1399 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_columnNameAfterWhere1402 = new BitSet(new long[]{0x0000000000000100L});
	public static final BitSet FOLLOW_ASC_in_columnNameAfterWhere1405 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_alias_in_columnNameAfterWhere1420 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_columnNameAfterWhere1423 = new BitSet(new long[]{0x0000000000100000L});
	public static final BitSet FOLLOW_DESC_in_columnNameAfterWhere1426 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_alias_in_columnNameInUpdate1447 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_columnNameInUpdate1450 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_identifier_in_table_alias1460 = new BitSet(new long[]{0x0000000001000000L});
	...
	public static final BitSet FOLLOW_expr_in_values1491 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_values1495 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_in_values1497 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_expr_in_values_func1516 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_values_func1520 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_in_values_func1523 = new BitSet(new long[]{0x0000000000004002L});
	...
	public static final BitSet FOLLOW_76_in_value1545 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_value1549 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_in_value1552 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	...
	public static final BitSet FOLLOW_76_in_value_simple1588 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_value_simple1592 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_expr_in_value_simple1594 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	...
	public static final BitSet FOLLOW_column_spec_in_column_specs1622 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_column_specs1626 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_column_spec_in_column_specs1628 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_a_table_in_selected_table1649 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_selected_table1652 = new BitSet(new long[]{0x0000100200000200L});
	public static final BitSet FOLLOW_a_table_in_selected_table1654 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_table_spec_in_a_table1672 = new BitSet(new long[]{0x0000000200000202L,0x0000000000004000L});
	public static final BitSet FOLLOW_alias_in_a_table1675 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_schema_name_in_table_spec1697 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_DOT_in_table_spec1699 = new BitSet(new long[]{0x0000000200000200L});
	...
	public static final BitSet FOLLOW_table_name_in_column_spec1733 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_DOT_in_column_spec1735 = new BitSet(new long[]{0x0000000200000200L});
	...
	public static final BitSet FOLLOW_78_in_alias1789 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_identifier_in_alias1793 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_selectClause_in_select_command2342 = new BitSet(new long[]{0x0000000000000002L,0x00040C1623C00000L});
	public static final BitSet FOLLOW_fromClause_in_select_command2345 = new BitSet(new long[]{0x0000000000000002L,0x00040C1623400000L});
	public static final BitSet FOLLOW_joinClause_in_select_command2350 = new BitSet(new long[]{0x0000000000000002L,0x00040C1623400000L});
	public static final BitSet FOLLOW_whereClause_in_select_command2355 = new BitSet(new long[]{0x0000000000000002L,0x0000041003400000L});
	public static final BitSet FOLLOW_groupByClause_in_select_command2360 = new BitSet(new long[]{0x0000000000000002L,0x0000041002400000L});
	public static final BitSet FOLLOW_orderByClause_in_select_command2365 = new BitSet(new long[]{0x0000000000000002L,0x0000001002400000L});
	public static final BitSet FOLLOW_limitClause_in_select_command2370 = new BitSet(new long[]{0x0000000000000002L,0x0000000002400000L});
	public static final BitSet FOLLOW_indexClause_in_select_command2374 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_88_in_groupByClause2389 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_groupByColumns_in_groupByClause2391 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_groupByColumn_in_groupByColumns2407 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_COMMA_in_groupByColumns2410 = new BitSet(new long[]{0x0000000200000200L});
	public static final BitSet FOLLOW_groupByColumn_in_groupByColumns2413 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_identifier_in_groupByColumn2425 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_86_in_indexClause2436 = new BitSet(new long[]{0x0000000000000000L,0x0000000008000000L});
	public static final BitSet FOLLOW_91_in_indexClause2438 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_LPAREN_in_indexClause2440 = new BitSet(new long[]{0x2481500202000200L,0x0000908000261000L});
	public static final BitSet FOLLOW_select_list_in_indexClause2442 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_indexClause2445 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_89_in_indexClause2450 = new BitSet(new long[]{0x0000000000000000L,0x0000000008000000L});
	public static final BitSet FOLLOW_91_in_indexClause2452 = new BitSet(new long[]{0x0000100000000000L});
	public static final BitSet FOLLOW_LPAREN_in_indexClause2454 = new BitSet(new long[]{0x2481500202000200L,0x0000908000261000L});
	public static final BitSet FOLLOW_select_list_in_indexClause2456 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
	public static final BitSet FOLLOW_RPAREN_in_indexClause2458 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_83_in_delete_command2468 = new BitSet(new long[]{0x0000000000000000L,0x0000000000800000L});
	public static final BitSet FOLLOW_fromClause_in_delete_command2470 = new BitSet(new long[]{0x0000000000000002L,0x0004041000000000L});
	public static final BitSet FOLLOW_whereClause_in_delete_command2472 = new BitSet(new long[]{0x0000000000000002L,0x0000041000000000L});
	public static final BitSet FOLLOW_orderByClause_in_delete_command2475 = new BitSet(new long[]{0x0000000000000002L,0x0000001000000000L});
	public static final BitSet FOLLOW_limitClause_in_delete_command2480 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_112_in_update_command2506 = new BitSet(new long[]{0x0000100200000200L});
	public static final BitSet FOLLOW_selected_table_in_update_command2508 = new BitSet(new long[]{0x0000000000000000L,0x0000400000000000L});
	public static final BitSet FOLLOW_setclause_in_update_command2511 = new BitSet(new long[]{0x0000000000000002L,0x0004001000000000L});
	public static final BitSet FOLLOW_whereClause_in_update_command2513 = new BitSet(new long[]{0x0000000000000002L,0x0000001000000000L});
	public static final BitSet FOLLOW_limitClause_in_update_command2518 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_100_in_limitClause2543 = new BitSet(new long[]{0x0001000000000000L,0x0000000000001000L});
	public static final BitSet FOLLOW_skip_in_limitClause2546 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_COMMA_in_limitClause2548 = new BitSet(new long[]{0x0001000000000000L,0x0000000000001000L});
	...
	public static final BitSet FOLLOW_76_in_skip2583 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_N_in_range2597 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_76_in_range2607 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_joinType_in_joinClause2623 = new BitSet(new long[]{0x0000100200000200L});
	public static final BitSet FOLLOW_table_spec_in_joinClause2625 = new BitSet(new long[]{0x0000000200000200L,0x0000010000004000L});
	public static final BitSet FOLLOW_alias_in_joinClause2627 = new BitSet(new long[]{0x0000000000000000L,0x0000010000000000L});
	public static final BitSet FOLLOW_104_in_joinClause2630 = new BitSet(new long[]{0x2481500202000200L,0x000090C000201000L});
	public static final BitSet FOLLOW_sqlCondition_in_joinClause2632 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_81_in_concat2677 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_table_alias_in_identifiedOrQuotedString2690 = new BitSet(new long[]{0x0000000200000200L});
	...
	public static final BitSet FOLLOW_84_in_distinct2710 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_82_in_count2720 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_identifier_in_countColumn2748 = new BitSet(new long[]{0x0000000001000000L});
	public static final BitSet FOLLOW_DOT_in_countColumn2750 = new BitSet(new long[]{0x0001000200000200L});
	public static final BitSet FOLLOW_identifierOrN_in_countColumn2754 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_LPAREN_in_synpred1_MySQLParser565 = new BitSet(new long[]{0x2481500202000200L,0x0000908000201000L});
	public static final BitSet FOLLOW_condition_or_in_synpred1_MySQLParser567 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000001L});
