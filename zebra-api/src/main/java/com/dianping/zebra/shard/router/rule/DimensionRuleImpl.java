...
//
//	@Override
//	public boolean eval(ShardMatchContext matchContext) {
...
//			Set<Object> shardColValues = ShardColumnValueUtil.eval(matchContext.getParseResult(),
...
//				whiteListRule.eval(matchContext);
//			}
//
