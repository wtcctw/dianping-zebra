...
public class CatLogTest extends MultiDatabaseTestCase {
	...
	public void testPreparedStatementUpdate() throws Exception {
		ExecutionContextHolder.getContext().add(SQL_STATEMENT_NAME, "testPreparedStatementUpdate");
		execute(new ConnectionCallback() {
	...
	public void testPreparedStatementBatch() throws Exception {
		ExecutionContextHolder.getContext().add(SQL_STATEMENT_NAME, "testPreparedStatementBatch");
		execute(new ConnectionCallback() {
